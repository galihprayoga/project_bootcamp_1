                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <h5><a class="nav-link text-white" href="{{ route('login') }}">{{ __('Login') }}</a></h5>
                                </li>
                            @endif

                            @if (Route::has('register'))
                                <li class="nav-item">
                                <h5><a class="nav-link text-white" href="{{ route('register') }}">{{ __('Register') }}</a></h5>
                                </li>
                            @endif
                        @else
                            ...
                            <h5><li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown"  style="z-index:9999;">
                                    ...
                                    <a class="dropdown-item" href="{{ url('history_pembelian') }}">
                                        <i class="fa fa-history" style="z-index:9999;"></i> {{ __('History Pembelian') }}
                                    </a>
